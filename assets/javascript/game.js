var config = {
    apiKey: "AIzaSyCk4C_56MHSpGKzYSVHwmRQPfTovoFRjUs",
    authDomain: "trainsc9.firebaseapp.com",
    databaseURL: "https://trainsc9.firebaseio.com",
    projectId: "trainsc9",
    storageBucket: "",
    messagingSenderId: "877763464834"
  };
  firebase.initializeApp(config);

$(document).ready(function(){

	var trainData = new Firebase("https://trainsc9.firebaseio.com");
s
